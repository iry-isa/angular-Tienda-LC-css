...
const mariaRoutes: Routes = [
    {
        path: 'maria', component: MariaComponent, data: { titulo: 'Maria' }
    ...
    { path: 'editproducto', component: EditProductoComponent, data: { titulo: 'EditProducto' } },
    { path: 'editpuerta', component: EditPuertaComponent, data: { titulo: 'EditPuerta' } },
    { path: 'editventana', component: EditventanaComponent, data: { titulo: 'EditVentana' } },
...
export const MARIA_ROUTES = RouterModule.forChild( mariaRoutes );
